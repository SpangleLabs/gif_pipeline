...
- `twitter`: Details for twitter subscriptions, as well as for posting to twitter accounts
  ...
  - `twitter.consumer_key`: (`str`) Used by twitter posting, consumer_key as generated by `scripts/get_twitter_token.py`
  - `twitter.consumer_secret`: (`str`) Used by twitter posting, consumer_secret as generated by `scripts/get_twitter_token.py`
- `instagram`
